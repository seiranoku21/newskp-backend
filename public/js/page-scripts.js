...
function initPlugins(){
	...
	$('.ajax-pagination').each(function(){
		...
		pager.twbsPagination({
			...
			first: 'vradicon[first_page]vradicon',
			prev: 'vradicon[arrow_back]vradicon',
			next: 'vradicon[arrow_forward]vradicon',
			last: 'vradicon[last_page]vradicon',
